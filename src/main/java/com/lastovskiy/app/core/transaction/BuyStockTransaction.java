...
@ToString
@Getter
public class BuyStockTransaction implements Transaction {
    private static final TransactionType TRANSACTION_TYPE = TransactionType.BUY_STOCK;
    ...
    public BuyStockTransaction(int eventId, int stockId, int quantity, double pricePerStock) {
        this.eventId = eventId;
        this.stockId = stockId;
        this.quantity = quantity;
        this.pricePerStock = pricePerStock;
        this.totalAmount = quantity * pricePerStock;
    }
    ...
    public void applyTo(Account account) {
        account.getPortfolio().buyStock(stockId, quantity, pricePerStock);
        account.decreaseBalance(this.totalAmount);
    }
